...
#| fig-pos: hold
#| echo: false
knitr::include_graphics("./ms/images/img_IDEA_repliCATS.png")
```
...
knitr::include_graphics("./ms/images/paste-80B1C5CB.png")
```
...
This research was conducted as a part of the [repliCATS project](https://replicats.research.unimelb.edu.au), funded by the [DARPA SCORE programme](https://www.darpa.mil/program/systematizing-confidence-in-open-research-and-evidence.)
