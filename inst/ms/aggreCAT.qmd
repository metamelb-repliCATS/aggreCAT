...
where each participant receives a `quiz_score` from 0 - **X (TODO)** if
they completed the quiz, and `NA` if they did not attempt or fully
complete the quiz [see @Hanea2021 for further details]. (Question for
Bonnie, possibly Rose?: Pretty sure they get points for any question
