...
`data_ratings`. On the repliCATS platform users were given the option to
comment on others' justifications (`data_comments`), to vote on others'
comments (`data_comment_ratings`) and on others' justifications
(`data_justification_ratings`). Justifications for giving particular
judgements are contained in `data_justifications`. Finally,
[aggreCAT]{.pkg} contains three 'supplementary' datasets containing data
