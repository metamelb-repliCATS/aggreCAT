...
#| tbl-cap: "Focal Claim Data: expert judgements for claim derived from a subset of 5 claims and 5 participants from `data\_ratings`. Judgements are displayed as percentages."
#| eval: true
#| echo: false
#| results: asis
focal_claims %>% 
