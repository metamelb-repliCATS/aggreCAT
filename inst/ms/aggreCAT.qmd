...
[BayesianWAgg]{.fct} using the argument `priors` (@sec-bayesian-supplementary-data) with each claim having its own unique
prior.
...
aggreCAT:::method_summary_table %>% 
  ...
  kableExtra::kable_styling(latex_options = c("hold_position", "repeat_header"), font_size = 6) %>% 
