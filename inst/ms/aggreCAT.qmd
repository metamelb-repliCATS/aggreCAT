...
`postprocess_judgements()`, the `method`, `paper_id` , the Confidence Score `cs`, 
as well as the number of participants `n_experts` whose assessments were used in the aggregation,
...
A tibble of confidence scores `cs` for each `paper_id`, corresponding
