...
[@Wickham:2014vp]. Each aggregation method expects a [data.frame]{.class} or
...
elicitation (best-estimate, upper and lower bound), however, some methods
require only the best-estimates for mathematical aggregation. For every
