...
In this paper we give an overview of the [aggreCAT]{.pkg} package so that researchers may apply any of the aggregation functions described in [@Hanea2021], as well as additional methods provided by [aggreCAT]{.pkg}, to their own expert elicitation datasets where mathematical aggregation is required.
