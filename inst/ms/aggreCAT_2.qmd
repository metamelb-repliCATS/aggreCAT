...
In addition we have Bayesian WAgg that has two variants for fitting Bayesian model to determine the confidence score.
BayesianWAgg family of aggregators / methods, does some Bayesian model calculations to determine the confidence.

Drop bit about assuming normal distributiobn, people can go look at details of model on the help page.
Claim-specific prior distribution means rather than letting htem be some default prior.
