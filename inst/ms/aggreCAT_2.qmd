...
<!-- ? Check with @Doi90 about whether to merge the worked example code together for both functions, or whether I should separate them back out again and drop the example for IndIntWAgg -->

#### Participant-level Weights

<!-- TODO VarIndIntWAgg is eg of participant-level weights without external data -->

Related participant-level methods include `IndIntAsymWAgg()`, `VarIndIntWAgg()`, and `KitchSinkWAgg()`, which rescale weights using interval asymmetry or variability across claims and participants.
