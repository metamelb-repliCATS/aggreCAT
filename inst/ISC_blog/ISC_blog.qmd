...
format: 
  html:
    code-copy: hover
    code-link: true
    embed-resources: true #TODO turn off for submission, only for sharing output .html
...
author: 
  - name: David P. Wilkinson
    ...
    email: dwilkinson@unimelb.edu.au
  - name: Elliot Gould
...
We’re always happy to hear from existing and would-be users about any additional features that would help them conduct their own research or practitioners conducting their own elicitations. If you have any requests, you can submit them as an [issue on our GitHub repository](https://github.com/metamelb-repliCATS/aggreCAT/issues) and we can add them to our to do lists, or you’re welcome to submit pull requests with additional features that you’ve coded up that we will review and evaluate for inclusion in the package down the line. Finally, we are [contactable by email](mailto:dwilkinson@unimelb.edu.au) should you have any queries about the package, or about our research at [MetaMelb](https://arts.unimelb.edu.au/school-of-historical-and-philosophical-studies/our-research/metamelb).
