...
The `aggreCAT` package aims to fill this void, implementing **XYZ** unique state-of-the-art methods for mathematically aggregating expert judgements.

Mathematically-speaking, there are three main types of aggregation methods provided by `aggreCAT`: unweighted linear combinations of judgements, weighted linear combinations of judgements where weights are proxies of forecasting performance constructed from characteristics of participants and/or their judgements, and, and Bayesian methods that use expert judgement to update uninformative and informative priors.
...
-   the most recent official version of `aggreCAT` from CRAN:
    ...
    -   TBC! *We will upload to CRAN once our manuscript has been submitted.*
